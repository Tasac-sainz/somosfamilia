...
const kittenData_1 = {
    ...
    descripKitten:
        "Es un gato muy cariñoso y familiar que se reconoce por su gran capacidad comunicativa, ya que es un gato muy hablador y exigente, a veces casi tirano con las personas con las que vive. Sin embargo, es también el gato más amoroso del mundo. Fiel a sus rutinas y hábitos, es el compañero perfecto.",
    imageKitten:
        "https://img.freepik.com/fotos-premium/gato-comun-europeo-naranja-mirando-adelante-descansando-retrato-animal_470418-1079.jpg",
};
...
const kittenData_3 = {
    ...
    raceKitten: "(Bombay)",
    descripKitten:
        "Es una gata elegante pero fuerte; tiene una naturaleza curiosa, activa y muy afectuosa. Le gusta pasar tiempo con sus dueños y es muy sociable con las personas. Tan extrovertida como un perro, el gato de raza Bombay, conocido por su pelaje negro intenso, tiene el pelo corto y liso.",
    imageKitten:
        "https://www.zoomalia.com/blogz/5306/tout-savoir-sur-chat-bombay.jpeg",
};
const kittenData_4 = {
    nameKitten: "Trufa",
    raceKitten: "(Tricolor)",
    descripKitten:
        "Esta gata se caracteriza por ser sigilosa y precavida, le cuesta tener confianza pero cuando lo hace, es cariñosa e incluso, un poco dependiente, busca el contacto con su persona de referencia y le encanta jugar.",
    imageKitten:
        "https://wamiz.es/media/cache/upload_original-size/article/images/WAMIZ%20MX/2021-AGOSTO/gata%20tricolor.jpg",
};
const kittenData_5 = {
    nameKitten: "Pancho",
    raceKitten: "(Siamés)",
...
const kittenData_7 = {
    ...
    imageKitten:
        "https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcS9HGsgu-cCqVzjgql9_8zmfCFiOwg3jYTXQEBAH31Uc3jz-tKkRhL-JrigOrTo_pU_1qFulMi8n5hjgKyY1BNHtqQ5tbme4YoInWgVhw",
};
...
const kittenData_8 = {
    ...
    raceKitten: "(Toyger)",
    descripKitten:
        "El gato Toyger es una raza que busca parecerse al máximo a un tigre en miniatura. Tiene un llamativo pelaje corto, le encanta perseguir a los miembros de la familia, acurrucarse a su lado y demandar atención. El Toyger repartirá su cariño por igual con todos los habitantes del hogar. Dato curioso: a los gatitos Toyger les encanta el agua!",
    imageKitten:
        "https://www.tiendanimal.es/articulos/wp-content/uploads/2022/02/Toyger-640x427.jpg",
};
